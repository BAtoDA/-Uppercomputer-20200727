# -Uppercomputer-20200727
                                                             关于
关于本软件 暂时停止更新 全力开发  无代码访问PLC的控件 通过Visual Studio 拖拽控件设置相应的参数就可以访问PLC简单易用 适用于工业开发作为底层减少项目代码量提高稳定性 目前支持5款控件 正在全力开发
敢兴趣的请移步：https://github.com/BAtoDA/Bottom_Control     
