...
namespace 欧姆龙Fins协议.欧姆龙.报文处理
{
    ...
    class OmronFinsTcp : PLC_public_Class, IPLC_interface
    {
        ...
        /// </summary>
        public static OmronFinsNet busTcpClient = null;//引用HslCommunication.ModBus进行实现
                                                       //实现接口的属性
        /// <summary>
        /// 实现接口的属性 PLC状态
        /// </summary>
        ...
        public OmronFinsTcp(IPEndPoint iPEndPoint, string pattern)//构造函数---初始化---open
        {
            OmronFinsTcp.IPEndPoint = iPEndPoint;//实例化IP地址
