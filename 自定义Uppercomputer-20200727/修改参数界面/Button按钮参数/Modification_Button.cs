...
namespace 自定义Uppercomputer_20200727.修改参数界面
{
    ...
    public partial class Modification_Button : Skin_VS
    {
        ...
        {
            //查询数据库是否有该数据
            if (Button_EF.Button_Parameter_inquire(this.skinTextBox8.Text) == "OK")
            {
        ...
        private void skinButton2_Click(object sender, EventArgs e)//用户点击了保存
        {
            ...
            public_AttributeCalss.attributeCalss((Button_reform)this.all_purpose, button_EF.Button_Parameter_Query(skinTextBox8.Text.Trim()));//查询数据库--进行设置后的参数修改
