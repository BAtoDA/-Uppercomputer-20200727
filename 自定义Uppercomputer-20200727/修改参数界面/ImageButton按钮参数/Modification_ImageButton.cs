...
namespace 自定义Uppercomputer_20200727.修改参数界面.ImageButton按钮参数
{
    public partial class Modification_ImageButton : Skin_VS
    {
        ...
        {
            //查询数据库是否有该数据
            if (Button_EFbase.Button_Parameter_inquire<ImageButton_Class>(this.skinTextBox8.Text) == "OK")
            {
                Button_EFbase button_EF = new Button_EFbase();//实例化EF对象
                button = button_EF.Button_Parameter_Query<ImageButton_Class>(this.skinTextBox8.Text);//获取按钮类全部参数
                List_Index();//开始改变索引
        ...
        private void skinButton2_Click(object sender, EventArgs e)
        {
            ...
            public_AttributeCalss.attributeCalss((ImageButton_reform)this.all_purpose, button_EF.Button_Parameter_Query<ImageButton_Class>(skinTextBox8.Text.Trim()));//查询数据库--进行设置后的参数修改
