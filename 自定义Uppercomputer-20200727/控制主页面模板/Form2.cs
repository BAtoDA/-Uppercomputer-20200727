...
namespace 自定义Uppercomputer_20200727
{
    public partial class Form2 : CCWin.Skin_Mac
    {
        ...
        private void skinButton1_Click(object sender, EventArgs e)//公用页面处理
        {
            ...
            Windowclass windowclass = new Windowclass(this, new SkinButton[] { this.skinButton1, this.skinButton2, this.skinButton3,
            ...
            {
                if (windowclass.Dispose_run)
                {
                    //time_Reform.Dispose();
                    //this.buttton按钮ToolStripMenuItem.Dispose();
                    //this.PLC_circulation_read.Dispose();
        ...
        public void Dispose_form(Form form)
        {
            FormCollection formCollection = Application.OpenForms;//获取窗口集合
            for (int i = 0; i < formCollection.Count; i++)
            {
                if (formCollection[i].Text != "Home" & formCollection[i].Text != form.Text)//关闭其余窗口
                {
                    formCollection[i].Dispose(); ;//关闭窗口     
                }
            }
            GC.Collect();//通知GC开始垃圾清理
        }
        ...
        private void Form2_Shown(object sender, EventArgs e)//添加控件
        {
            ...
            { 
                    ...
                    From_Load_Add add = new From_Load_Add(this.Name, this.Controls, new List<ImageList>() { this.imageList1, this.imageList2, this.imageList3 }, this,true);//添加普通文本
            ...
            var T = Task.Run(() =>
              ...
              if (time_Reform.TextBox_read_status != false || time_Reform.Button_read_status != false || time_Reform.Switch_read_status != false
                  ...
                  if (PLC_read_ok != true)
                  {
                      ...
                      button_Reforms = null;
                      skinTextBox_Reforms = null;
                      Switch_reforms = null;
                      LedBulb_reforms = null;
                      ImageButton_reforms = null;
                      doughnut_Chart_reforms = null;
                      histogram_Chart_reforms = null;
                      oscillogram_Chart_reforms = null;
                      AnalogMeter_reforms = null;
                      LedDisplay_reforms = null;
                      ihatetheqrcode_reforms = null;
                  }
              });
